...
define gui.idle_small_color = '#001526'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#2b4bb6'

## The color used for a text button when it is selected but not focused.
define gui.selected_color = '#43a4fc'
...
define gui.text_font = "gui/patrick.ttf"

## The font used for character names.
define gui.name_text_font = "gui/patrick.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "gui/moo.ttf"
...
image mainbg:
        "gui/menu1.png"
        "gui/menu2.png" with Dissolve(1.0, alpha=True)
        pause 1.0
        "gui/menu3.png" with Dissolve(1.0, alpha=True)
        pause 1.0
        "gui/menu2.png" with Dissolve(1.0, alpha=True)
        pause 1.0
        "gui/menu1.png" with Dissolve(1.0, alpha=True)
        pause 1.0
        repeat

# define gui.main_menu_background = "gui/main_menu.png"
define gui.main_menu_background = "mainbg"
...
define gui.confirm_frame_borders = Borders(120, 60, 120, 40)
